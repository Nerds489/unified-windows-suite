...
# Explicit dependency. The original relied on a -Global import from the entry point,
# which made this module unusable standalone.
Import-Module "$PSScriptRoot\..\Core\CommonFunctions.psm1" -Force -ErrorAction SilentlyContinue
